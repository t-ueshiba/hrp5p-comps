...
if(WIN32)
  ...
  if(OPENRTM_DIR )
    ...
    elseif(${OPENRTM_DIR} MATCHES ".*\\/0\\.4$")
      set(OPENRTM_DEFAULT_VERSION ${OPENRTM_VERSION042})
    elseif( ${OPENRTM_DIR} MATCHES ".*\\\\1\\.0\\\\$" )
      set(OPENRTM_DEFAULT_VERSION ${OPENRTM_VERSION100})
    elseif(${OPENRTM_DIR} MATCHES ".*\\/1\\.0$")
      set(OPENRTM_DEFAULT_VERSION ${OPENRTM_VERSION100})
    elseif( ${OPENRTM_DIR} MATCHES ".*\\\\1\\.1\\\\$" )
      set(OPENRTM_DEFAULT_VERSION ${OPENRTM_VERSION110})
    elseif(${OPENRTM_DIR} MATCHES ".*\\/1\\.1$")
      set(OPENRTM_DEFAULT_VERSION ${OPENRTM_VERSION110})
    endif()
    ...
    elseif(OPENRTM_VERSION STREQUAL ${OPENRTM_VERSION110})
      set(OPENRTM_LIBRARIES_RELEASE RTC110 coil110)
      set(OPENRTM_NODEBUG_LIBRARIES ws2_32 mswsock)
    endif()
