...
#   TUQTPP_INCLUDE_PATH,	TUQTPP_LIB,	TUQTPP_FOUND
...
if (UNIX)
  ...
  find_path(TUQTPP_INCLUDE_PATH	TU/qt/ImageView.h ${TULIBS_INC_SEARCH_PATH})
  find_library(TUQTPP_LIB	TUQt++		  ${TULIBS_LIB_SEARCH_PATH})

  if(TUQTPP_LIB AND TUQTPP_INCLUDE_PATH)
    set(TUQTPP_FOUND TRUE)
    set(TULIBS_INCLUDE_DIRS ${TULIBS_INCLUDE_DIRS} ${TUQTPP_INCLUDE_PATH})
  endif()
